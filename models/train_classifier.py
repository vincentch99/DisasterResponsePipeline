...
def tokenize(text):
    ...
    clean_tokens = []
    for token in tokens:
        clean_tok = lemmatizer.lemmatize(token).lower().strip(string.punctuation)
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    print(classification_report(Y_test, df_Y_pred, target_names=category_names))
